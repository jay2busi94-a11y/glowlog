...
//
// `gradient` is a static Tailwind class so it survives purging — never
...
export const BRANDS = [
  {
    ...
    name: 'CeraVe',
    emoji: '🛡️',
    gradient: 'from-sky-500/30 via-sky-500/10 to-blue-600/20',
  ...
  },
  {
    ...
    name: 'The Ordinary',
    emoji: '🧪',
    gradient: 'from-zinc-500/30 via-zinc-500/10 to-stone-600/20',
  ...
  },
  {
    ...
    name: "Paula's Choice",
    emoji: '🔬',
    gradient: 'from-emerald-500/30 via-teal-500/10 to-cyan-600/20',
  ...
  },
  {
    ...
    name: 'COSRX',
    emoji: '🐌',
    gradient: 'from-lime-500/30 via-green-500/10 to-emerald-600/20',
  ...
  },
  {
    ...
    emoji: '🌾',
    gradient: 'from-amber-500/30 via-yellow-500/10 to-orange-500/20',
  ...
  },
  {
    ...
    name: 'Tatcha',
    emoji: '🌸',
    gradient: 'from-pink-500/30 via-rose-500/10 to-fuchsia-500/20',
  ...
  },
  {
    ...
    name: 'SkinCeuticals',
    emoji: '⚗️',
    gradient: 'from-purple-500/30 via-purple-500/10 to-violet-600/20',
  ...
  },
  {
    ...
    name: 'Vanicream',
    emoji: '🤍',
    gradient: 'from-slate-500/30 via-slate-500/10 to-gray-600/20',
  ...
  },
  {
    ...
    name: 'Bioderma',
    emoji: '💧',
    gradient: 'from-blue-500/30 via-blue-500/10 to-sky-600/20',
  ...
  },
  {
    ...
    name: 'Stridex',
    emoji: '🟣',
    gradient: 'from-fuchsia-500/30 via-pink-500/10 to-rose-600/20',
  ...
  },
  {
    ...
    name: 'Differin',
    emoji: '🧫',
    gradient: 'from-orange-500/30 via-red-500/10 to-rose-600/20',
  ...
  },
  {
    ...
    name: 'Aveeno',
    emoji: '🌾',
    gradient: 'from-yellow-500/30 via-amber-500/10 to-orange-600/20',
  ...
  },
  {
    ...
    name: 'Drunk Elephant',
    emoji: '🐘',
    gradient: 'from-rose-500/30 via-pink-500/10 to-fuchsia-600/20',
  ...
  },
  {
    ...
    name: 'Glow Recipe',
    emoji: '🍉',
    gradient: 'from-pink-500/30 via-rose-500/10 to-red-500/20',
